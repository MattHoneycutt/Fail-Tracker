...
$projVsDocPath = Join-Path $projectFolder Scripts\jquery-1.7-vsdoc.js
$origVsDocPath = Join-Path $installPath Content\Scripts\jquery-1.7-vsdoc.js
$origVsDocParaPath = Join-Path $toolsPath jquery-1.7-vsdoc-para.js
